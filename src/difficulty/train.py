...
tf.flags.DEFINE_string("annotype", None, "Genre (default: outdoor)")
...
annotype = FLAGS.annotype

dataset = data_helpers.Dataset('../../dataset', annotype)

x_train_text, y_train, x_test_text, y_test = dataset.load_train_test(test_percent=0.2)
...
print ('Max length of document: ', max_document_length)
