...
def cal_workers_true_acc(cd, true_labs, ne=3, n_workers=47, print_out=False, return_ss=False, smooth_0=10.0, smooth_1=10):
    """
    ...
    correct_1 = np.zeros((10, n_workers))  # when true class is 1
    #wrong_0 = np.zeros((47,))
    wrong_1 = np.zeros((10, n_workers))
